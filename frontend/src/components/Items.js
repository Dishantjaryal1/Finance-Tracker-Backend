...
function Items(props) {
  ...
  return (
    <div className='flex bg-black rounded-2xl font-mont w-full p-5 flex-col smr gap-2 '>
        <div className='text-white flex  justify-between smr  '>
        <p className='text-white font-bold text-xl justify-between font-mont '>₹ {exp.amount}</p>
        ...
        <div className=''>
          <span className='text-white p-0  text-xs'>{exp.note}</span>
        </div>
        <div className='grid grid-flow-col  justify-between smr  '>
          ...
          deleteExpense(datar )}
        }  href="#_" className="rounded-md w-fit px-2 py-1 m-1 overflow-hidden relative group cursor-pointer border-2 font-medium border-indigo-600 text-white">
